...
```javascript
import linkedList from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-linked-list@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-linked-list/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-linked-list/actions/workflows/test.yml?query=branch:v0.2.0
